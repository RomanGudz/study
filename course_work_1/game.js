...
(() => {
  ...
  const gameMarble = () => {
    ...
    const botGuesses = (moveBot, guessNumberPlayer) => {
    ...
    const playerGuesses = (movePlayer, guessNumberBot) => {
